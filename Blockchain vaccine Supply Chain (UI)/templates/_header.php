...
<head>
    ...
    <title>Blockchain based COVID Vaccine Delivery System</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0 sidebar">
            <div class="navbar-header"> 
                <a class="logo" href="index.php" style="color:cornsilk;"><img src="plugins/images/logo.jpg" alt="home" /> BLOCKCHAIN BASED COVID VACCINE DELIVERY SYSTEM USING SMART CONTRACTS </a>
            </div>
        </nav>
        <!-- Left navbar-header -->
